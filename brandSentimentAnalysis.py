...
def anjie_brands(brand, country = 'all', csvFileName = 'brandNews.csv'):
    #TODO: show progress
       
        
        searchKeyword = "-".join(brand.split()) 
        ...
        if country == "all":
            ...
            csvfile = open(f"{csvFileName}",'w', newline='')
            ...
            print("These are the newspapers scraped and the total number of posts from them")
